...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e70a69496b2044ef761ba85488a6daaebaf0dcb57fd6ffbd91f0f46d381de1b3.js',function(){input.required=false;search();});}
