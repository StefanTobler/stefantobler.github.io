...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.66bebebfe93324a84ebe23eebdf6acf07bf9b052f820c9be49fcdf2e74f3872d.js',function(){input.required=false;search();});}
